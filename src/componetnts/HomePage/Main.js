...
const [showModule, setShowModule] = useState(false)
  ...
  return (
    <div className='main'>
      ...
      <Card style={{ width: '100%', flexDirection:"row",flexWrap: "wrap" }} className='p-3 d-flex align-items-center'>
          <div >
          ...
          <button className='main-btn' onClick={handelClick} disabled={props.landing? true:false}>start a post..</button>
          </div>
          <div className='box d-flex align-items-center w-100 mt-3'>
            <Col className='d-flex align-items-center gap-2'>
            <i class="fa-solid fa-image" style={{color:"var(--main-color)"}}></i>
            ...
            <p style={{color:"var(--main-color)", margin:0}}>Write article</p>
            </Col>
          </div>
    </Card>
            <Post/>
