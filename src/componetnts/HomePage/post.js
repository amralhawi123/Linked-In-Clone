        ...
        <div>
          ...
          {props.articles.length > 0 &&
            props.articles.map((post, index) => (
              <Card
                key={index}
                className="card-ele d-flex flex-column my-3 p-3"
              >
                ...
                <div className="post-image w-100">
                  <a href="#amr">
                    {!post.shareImg && post.video ? (
                      ...
                      post.shareImg && (
                        <img src={post.shareImg} alt="" className="w-100" />
                      )
                    )}
                  </a>
                </div>
                <div className="post-social">
                  <ul className="d-flex align-items-center gap-2 p-0 my-2">
                    ...
                    <li>
                      <a href="#amr" className="text-dark">
                      ...
                      <div className="comment p-3">
                        <a href="#amr" className="d-flex align-items-center">
                          ...
                          <div className="mx-2 d-flex flex-column coment-post">
                            <p className="fs-7 fw-bold m-0 text-dark">
                              {post.actor.title}
                            </p>
                        ...
                        <span
                          className="d-block text-muted w-100"
                          style={{ margin: "5px 50px" }}
                        >
                          <span>Like</span>
                          <span className="mx-3"> Reply </span>
                          {post.timestamp &&
                ...
                <div className="p-3 comunt" id={post.id}>
                  <Form className="d-flex align-items-center mx-3 w-100">
                    ...
                    <Button
                      variant="primary"
                      onClick={() => handelSendComment(post.id)}
                      disabled={!coments ? true : false}
                      style={{
                        display: "flex",
                        backgroundColor: "#cecccc38",
                        border: "2px solid #cecccc38",
                      }}
                    >
                      <img src={send} style={{ rotate: "42deg" }} alt="" />
                    </Button>
                  </Form>
                </div>
              </Card>
